...
Java_me_longluo_ffmpeg_creator_MediaFileBuilder_nativeCreateFromFD(JNIEnv *,
                                                                           jobject instance,
                                                                           jint fileDescriptor,
...
JNIEXPORT void JNICALL
Java_me_longluo_ffmpeg_creator_MediaFileBuilder_nativeCreateFromAssetFD(JNIEnv *env,
                                                                                jobject instance,
...
JNIEXPORT void JNICALL
Java_me_longluo_ffmpeg_creator_MediaFileBuilder_nativeCreateFromPath(JNIEnv *env,
                                                                             jobject instance,
                                                                             jstring jFilePath,
                                                                             jint mediaStreamsMask) {
